          ...
          <CardHeader className="bg-slate-800 text-white border-b">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <select
                ...
                className="px-3 py-2 border border-slate-200 rounded-md text-sm bg-white text-slate-800"
              >
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex gap-2 flex-wrap">
                              ...
                              >
                                <Badge 
                                  variant="outline" 
                                  className="bg-blue-50 text-blue-700 border-blue-200 text-xs cursor-pointer hover:bg-blue-100 transition-colors"
                                >
                              ...
                              >
                                <Badge 
                                  variant="outline" 
                                  className="bg-purple-50 text-purple-700 border-purple-200 text-xs cursor-pointer hover:bg-purple-100 transition-colors"
                                >
                              ...
                              {student.application_progress.applied > 0 && (
                                ...
                                >
                                  <Badge 
                                    variant="outline" 
                                    className="bg-orange-50 text-orange-700 border-orange-200 text-xs cursor-pointer hover:bg-orange-100 transition-colors"
                                  >
                        ...
                        <td className="p-4">
                          <div className="flex flex-col gap-2">
                            ...
                            <StudentNotesModal
                              ...
                              studentName={student.full_name}
                              onNotesUpdated={() => {
                                // Could refresh student data if needed
