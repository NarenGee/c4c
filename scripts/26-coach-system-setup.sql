-- Add new user roles for coach and super_admin
...
DROP POLICY IF EXISTS "Coaches and super admins can view student college lists" ON my_college_list;
...
DROP POLICY IF EXISTS "Coaches and super admins can update application stages" ON my_college_list;
